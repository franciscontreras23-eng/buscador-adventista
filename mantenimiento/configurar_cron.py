...
cron_cmd = '0 0 * * 5 cd "/Users/francis.contreras23/Library/CloudStorage/GoogleDrive-secretariosureste23@gmail.com/Mi unidad/Documentos Francis/Theology/Articulos, libros y otros documentos/Buscador_Libros" && /usr/bin/python3 mantenimiento/actualizar_buscador.py >> cron_log.txt 2>&1'
